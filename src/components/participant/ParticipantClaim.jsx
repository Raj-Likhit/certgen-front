                        ...
                        {!cert ? (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 gap-3.5 sm:gap-4">
                                    ...
                                    {cert.cert_png_url && (
                                        <button
                                            onClick={() => handleDownload(cert.cert_png_url, `Certificate.png`)}
                                            className="h-14 rounded-2xl bg-accent/20 text-white font-bold text-base sm:text-lg tracking-tight border border-accent/40 shadow-xl shadow-accent/5 hover:bg-accent/30 active:scale-[0.98] transition-all flex items-center justify-center gap-3"
                                        >
